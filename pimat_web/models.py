...
class Monitoring(db.Model):
    ...
    disk_total = db.Column(db.Integer(100))
    disk_used = db.Column(db.Integer(100))
    disk_free = db.Column(db.Integer(100))
    ...
    eth0_received = db.Column(db.Integer(100))
    eth0_sent = db.Column(db.Integer(100))
