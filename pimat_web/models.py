...
class Monitoring(db.Model):
    ...
    ram_free = db.Column(db.String(50))
    ram_used = db.Column(db.String(50))
    ram_used_percent = db.Column(db.Float)
    swap_total = db.Column(db.String(50))
    swap_free = db.Column(db.String(50))
    swap_used = db.Column(db.String(50))
    swap_used_percent = db.Column(db.Float)
    disk_total = db.Column(db.String(50))
    disk_used = db.Column(db.String(50))
    disk_free = db.Column(db.String(50))
    disk_used_percent = db.Column(db.Float)
    disk_total_boot = db.Column(db.String(50))
    disk_used_boot = db.Column(db.String(50))
    disk_free_boot = db.Column(db.String(50))
    disk_used_percent_boot = db.Column(db.Float)
    eth0_received = db.Column(db.String(50))
    eth0_sent = db.Column(db.String(50))
    wlan0_received = db.Column(db.String(50))
    wlan0_sent = db.Column(db.String(50))
    lo_received = db.Column(db.String(50))
    lo_sent = db.Column(db.String(50))
