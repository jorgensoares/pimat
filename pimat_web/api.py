...
class MonitoringAPI(Resource):
    def __init__(self):
        ...
        self.reqparse.add_argument('cpu_temp', type=str, default="", location='json')
        self.reqparse.add_argument('cpu_usage', type=str, default="", location='json')
        self.reqparse.add_argument('cpu_frequency', type=str, default="", location='json')
        self.reqparse.add_argument('load_1', type=str, default="", location='json')
        self.reqparse.add_argument('load_5', type=str, default="", location='json')
        self.reqparse.add_argument('load_15', type=str, default="", location='json')
        self.reqparse.add_argument('total_proc', type=str, default="", location='json')
        ...
        self.reqparse.add_argument('ram_used_percent', type=str, default="", location='json')
        ...
        self.reqparse.add_argument('swap_used_percent', type=str, default="", location='json')
        ...
        self.reqparse.add_argument('disk_used_percent', type=str, default="", location='json')
        ...
        self.reqparse.add_argument('disk_used_percent_boot', type=str, default="", location='json')
